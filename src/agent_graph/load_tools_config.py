...
class LoadToolsConfig:
    """
    Load and manage tool-specific configuration settings from a YAML config file and environment variables.

    This class supports loading configuration values for multiple AI tools and components including:
    ...
    The config file path: `configs/tools_config.yml`
    Some keys (e.g., API keys) are loaded from environment variables using `.env`.
    """

    def __init__(self) -> None:
        """
        Initialize the LoadToolsConfig class by:
        - Reading YAML configuration.
        - Mapping values to class attributes.
        - Loading environment variables for secure values like API keys.
        """
        ...
        self.travel_sqlagent_api_key = os.getenv("GEMINI_API_KEY")
        ...
        self.chinook_sqlagent_llm_api_key = os.getenv("GEMINI_API_KEY")
